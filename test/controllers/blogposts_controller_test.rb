...
class BlogpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post blogposts_url, params: { blogpost: { active: @blogpost.active, body: @blogpost.body, image: @blogpost.image, summary: @blogpost.summary, title: @blogpost.title, url: @blogpost.url } }
    end
  ...
  test "should update blogpost" do
    patch blogpost_url(@blogpost), params: { blogpost: { active: @blogpost.active, body: @blogpost.body, image: @blogpost.image, summary: @blogpost.summary, title: @blogpost.title, url: @blogpost.url } }
